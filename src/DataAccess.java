...
public class DataAccess {
    ...
    public void printTicket(Tour tour, Ticket ticket) throws FileNotFoundException {
        ...
        PrintWriter pw = new PrintWriter(file);
        pw.write("ID рейса: "+ticket.getTicketID());
        pw.println();
        ticket.setCustomer(ticket.getCustomer().replace(' ','_'));
        pw.write("Ф.И.О. клиента: "+ticket.getCustomer());
        pw.println();
        pw.write("Место отъезда: "+ticket.getStationFrom() + "   Время отъезда: " + ticket.getDepTime());
        pw.println();
        pw.write("Место прибытия: "+ticket.getStationTo() + "   Время прибытия: " + ticket.getArrTime());
        pw.println();
        pw.write("Дата: "+ticket.getDate());
        pw.println();
        pw.write("Место: "+Integer.toString(ticket.getPlaceNumber()));
        pw.println();
        pw.write("Цена:"+Double.toString(ticket.getPrice()));
        pw.println();
        pw.close();
    }
...
//        System.out.println(ds.getTourById("0001").toString());
        ...
        String [] days = {"1","2","3"};
        Tour tour1= new Tour("0002","Харьков-Полтава","Харьков","12:12","Полтава","17:10","30.12.2015",25,station,99.99,days,101,null);
        ds.addTour(tour1);
        ...
        Tour tour2= new Tour("0001","Купянск-Харьков","Купянск","14:36","Харьков","19:00","24.12.2015",150,station,5.94,days,300,null);
        ds.addTour(tour2);
        ...
        Tour tour3= new Tour("0003","Купянск-Полтава","Купянск","10:26","Полтава","19:00","24.12.2015",80,station,50.50,days,107,null);
        ds.addTour(tour3);
        ...
        Tour tour4= new Tour("0004","Купянск-Киев","Купянск","14:36","Киев","23:00","23.12.2015",150,station,150.57,days,300,null);
        ds.addTour(tour4);
        ...
        days = new String[]{"Ежедневно"};
        Tour tour5 = new Tour("0005", "Харьков-Купянск", "Харьков", "14:00", "Купянск", "17:00", "25.12.2015", 300, station, 6, days, 300, null);
        ds.addTour(tour5);
        ...
        Tour tour6= new Tour("0006","Харьков-Львов","Харьков","16:36","Львов","6:05","26.12.2015",179,station,306.23,days,300,null);
        ds.addTour(tour6);
    }
}
